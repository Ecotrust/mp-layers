...
class ThemeTest(TestCase):
    def setUp(self):
        ...
        self.child_theme1 = Theme.objects.create(name="Child Theme A", parent_theme=self.parent_theme1, layer_type="radio")
        self.child_theme2 = Theme.objects.create(name="Child Theme B", parent_theme=self.parent_theme2, layer_type="radio")
        self.child_theme3 = Theme.objects.create(name="Child Theme B", parent_theme=self.parent_theme2, layer_type="radio")
...
class LayerModelTest(TestCase):
    def setUp(self):
        ...
        self.layer1 = LayerWMS.objects.create(name="Layer 1")
        self.layer2 = Layer.objects.create(name="Layer 2")
        self.layer3 = Layer.objects.create(name="Layer 3")
    ...
    def test_companion_relationships(self):
        ...
        self.assertIn(self.layer2, self.companionship.companions.all())
        self.assertIn(self.layer3, self.companionship.companions.all())

        self.assertIn(self.companionship, self.layer2.companion_to.all())
        self.assertIn(self.companionship, self.layer3.companion_to.all())
...
class SubThemeSerializerTest(TestCase):
    def setUp(self):
        ...
        self.sub_theme = Theme.objects.create(name="Sub Theme", parent_theme=self.parent_theme, layer_type="radio")
        ...
        ChildOrder.objects.create(parent_theme=self.sub_theme, content_object=self.layer1, order=1)
    ...
    def test_subtheme_serialization(self):
        # Serialize the subtheme instance
        serializer = SubThemeSerializer(self.sub_theme)
        serialized_data = serializer.data

        verify_serializer_v1_output(self, serialized_data, name=self.sub_theme.name, layer_type=self.sub_theme.layer_type)

        # Extract only the 'id' from each item in 'subLayers'
        serialized_ids = [item['id'] for item in serialized_data['subLayers']]
    ...
    def setUp(self):
       ...
       # Create layers
        ...
        self.layer2 = LayerArcFeatureService.objects.create(name="testlayer2", arcgis_layers="19", password_protected=True,  disable_arcgis_attributes=True,
                                                            mouseover_field="hi", custom_style="test", vector_outline_width=5, vector_outline_color="blue", vector_outline_opacity=5.0,
                                                            vector_fill=5.0, vector_color="blue", point_radius=5, vector_graphic="Test", vector_graphic_scale=5.0, opacity=5.0)
        self.companionship = Companionship.objects.create(layer=self.layer1)
        self.companionship.companions.add(self.layer2)
        # Create layer orders
        ChildOrder.objects.create(parent_theme=self.theme1, content_object=self.layer1, order=2)
...
class VectorLayerTest(TestCase):
    def setUp(self):
        ...
        self.layer2 = LayerVector.objects.create(name="testlayer2", mouseover_field="hi", custom_style="test", vector_outline_width=5, vector_outline_color="blue", vector_outline_opacity=5.0,
                                                            vector_fill=5.0, vector_color="blue", point_radius=5, vector_graphic="Test", vector_graphic_scale=5.0, opacity=5.0)
    ...
    def test_layer_attributes(self):
        ...
        verify_serializer_v1_output(self, layer2_actual_data, name=self.layer2.name, layer_type="Vector", order=1, mouseover_field="hi", custom_style="test", vector_outline_width=5, vector_outline_color="blue", vector_outline_opacity=5.0,
                                                            vector_fill=5.0, vector_color="blue", point_radius=5, vector_graphic="Test", vector_graphic_scale=5.0, opacity=5.0)
...
class ChildOrderSerializerTest(TestCase):
    def setUp(self):
        ...
        self.sub_theme = Theme.objects.create(name="Sub Theme", parent_theme=self.parent_theme)
        # Create layers
