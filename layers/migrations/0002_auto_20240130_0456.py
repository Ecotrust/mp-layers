# Generated by Django 3.2.23 on 2024-01-30 04:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vector_graphic_scale', models.FloatField(blank=True, default=1.0, help_text='Scale for the vector graphic from original size.', null=True, verbose_name='Vector Graphic Scale')),
        ...
        migrations.AddField(
            model_name='theme',
            name='layer_type',
            field=models.CharField(choices=[('radio', 'radio'), ('checkbox', 'checkbox')], default='arcgis', help_text='use placeholder to temporarily remove layer from TOC', max_length=50),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='theme',
